            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        <div>
                            <h5 class="mb-0">Buat Pesanan</h5>
                        </div>
                        <a href="{{ route('operational.order') }}" class="btn bg-gradient-primary btn-sm mb-0"
                        ...
                        <form wire:submit.prevent="submit">
                            ...
                            <div class="form-group" wire:ignore>
                                ...
                                <select id="typeLayananSelect" wire:model.defer="layanan_id" class="form-control">
                                    ...
                                    <option value="3">Lepas Kunci</option>
                            ...
                            {{-- <div class="form-group" wire:ignore>
                                ...
                                <div style="display: flex">
                                    <input type="date" wire:model.defer="date_selesai"class="form-control w-60"
                                        placeholder="2023/01/01">
                                    <span class="mx-2"></span>
                                    <input type="time" wire:model.defer="time_selesai"class="form-control w-35"
                                        placeholder="06:30">
                                </div>
                            </div>
                            <div div style="display: flex">
                            ...
                            <div>
                                @if ($layanan_id == 1 || $layanan_id == 3 || $layanan_id == 4)
                                    <div class="form-group" wire:ignore>
                                        <label>Jam selesai</label>
                                        <div style="display: flex">
                                            <input type="date"
                            ...
                            @endif
                            <div>
                                @if ($layanan_id == 2 || $layanan_id == 3 || $layanan_id == 4)
                                    <div class="form-group">
                                        <label>Tempat Tujuan</label>
                                        <input type="text" wire:model.defer="address_to"class="form-control"
                                            placeholder="Pilih Lokasi tujuan here..." id='address-to'>
                            ...
                            {{-- <div class="form-group" wire:ignore>
                                <label>Tempat Penjemputan</label>
                                <input type="text" wire:model="address_from"class="form-control"
                                    placeholder="Pilih Lokasi penjemputan here..." id='address-from'>
                            </div> --}}
                            {{-- <div>
                                @error('address_from')
